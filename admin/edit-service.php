...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $stmt = $conn->prepare("UPDATE services SET name = ?, slug = ?, description = ?, icon = ?, is_active = ?, updated_at = NOW() WHERE id = ?");
        $stmt->bind_param("ssssis", $name, $slug, $description, $icon, $is_active, $service_id);
        
        if ($stmt->execute()) {
            $success_message = "Servizio aggiornato con successo!";
        } else {
            $error_message = "Si è verificato un errore durante l'aggiornamento del servizio. Riprova più tardi.";
        }
...
<head>
    ...
    <title>Modifica Servizio - Admin Panel</title>
            ...
            <div class="main-container">
                <div class="page-title">
                    ...
                    <div class="breadcrumb">
                        ...
                        <div class="breadcrumb-item active">
                            Modifica <?php echo htmlspecialchars($service['name']); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="content-box">
                    <div class="content-box-header">
                        ...
                        <div class="actions">
                            <a href="view-service.php?id=<?php echo $service_id; ?>" class="btn btn-secondary btn-sm">
                    ...
                    <div class="content-box-body">
                        <form action="edit-service.php?id=<?php echo $service_id; ?>" method="post">
                            <div class="form-row">
                                <div class="form-col">
                            ...
                            <div class="form-group">
                                ...
                                <div class="icon-selector">
                                    <?php foreach ($available_icons as $icon_class => $icon_name): ?>
                                        <div class="icon-option <?php echo $icon_class === $icon ? 'selected' : ''; ?>" data-icon="<?php echo $icon_class; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <a href="view-service.php?id=<?php echo $service_id; ?>" class="btn btn-secondary">
