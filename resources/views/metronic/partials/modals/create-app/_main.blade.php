...
@include('metronic.partials.modals.create-app.steps._step-1')
@include('metronic.partials.modals.create-app.steps._step-2')
@include('metronic.partials.modals.create-app.steps._step-3')
@include('metronic.partials.modals.create-app.steps._step-4')
@include('metronic.partials.modals.create-app.steps._step-5')
                            <!--begin::Actions-->
