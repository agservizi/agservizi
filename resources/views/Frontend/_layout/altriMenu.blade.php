        ...
        <i class="ki-duotone ki-cross fs-2 fs-lg-1 me-0"><span class="path1"></span><span class="path2"></span></i>    </span>
                    ...
                    <div class="scroll-y mh-200px mh-lg-350px">
                        ...
                        <a href="#"
                           class="d-flex text-dark text-hover-primary align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                                <img src="/assets_demo46/media/avatars/300-6.jpg" alt=""/>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <a href="#"
                           class="d-flex text-dark text-hover-primary align-items-center mb-5">
                            <!--begin::Symbol-->
                            <div class="symbol symbol-40px me-4">
                                <img src="/assets_demo46/media/avatars/300-2.jpg" alt=""/>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <a href="#"
                           class="d-flex text-dark text-hover-primary align-items-center mb-5">
                            <!--begin::Symbol-->
                            <div class="symbol symbol-40px me-4">
                                <img src="/assets_demo46/media/avatars/300-9.jpg" alt=""/>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <a href="#"
                           class="d-flex text-dark text-hover-primary align-items-center mb-5">
                            <!--begin::Symbol-->
                            <div class="symbol symbol-40px me-4">
                                <img src="/assets_demo46/media/avatars/300-14.jpg" alt=""/>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <a href="#"
                           class="d-flex text-dark text-hover-primary align-items-center mb-5">
                            <!--begin::Symbol-->
                            <div class="symbol symbol-40px me-4">
                                <img src="/assets_demo46/media/avatars/300-11.jpg" alt=""/>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <a href="#"
                           class="d-flex text-dark text-hover-primary align-items-center mb-5">
                            ...
                            <span class="symbol-label bg-light">
                                <img class="w-20px h-20px" src="/assets_demo46/media/svg/brand-logos/volicity-9.svg"
                                     alt=""/>
                            </span>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <a href="#"
                           class="d-flex text-dark text-hover-primary align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                            <span class="symbol-label bg-light">
                                <img class="w-20px h-20px" src="/assets_demo46/media/svg/brand-logos/tvit.svg" alt=""/>
                            </span>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <a href="#"
                           class="d-flex text-dark text-hover-primary align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                            <span class="symbol-label bg-light">
                                <img class="w-20px h-20px" src="/assets_demo46/media/svg/misc/infography.svg" alt=""/>
                            </span>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <a href="#"
                           class="d-flex text-dark text-hover-primary align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                            <span class="symbol-label bg-light">
                                <img class="w-20px h-20px" src="/assets_demo46/media/svg/brand-logos/leaf.svg" alt=""/>
                            </span>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <a href="#"
                           class="d-flex text-dark text-hover-primary align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                            <span class="symbol-label bg-light">
                                <img class="w-20px h-20px" src="/assets_demo46/media/svg/brand-logos/tower.svg" alt=""/>
                            </span>
                            </div>
                            <!--end::Symbol-->
            ...
            <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <a href="/metronic8/demo46/../demo46/pages/search/horizontal.html"
...
<div class="app-navbar-item ms-1 ms-lg-3">
    ...
    <div
        ...
        data-kt-menu-placement="bottom-end"
    >
        <i class="ki-duotone ki-picture fs-1"><span class="path1"></span><span
                class="path2"></span></i>
    </div>
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px"
        ...
        <div class="d-flex flex-column bgi-no-repeat rounded-top"
             style="background-image:url('/assets_demo46/media/misc/menu-header-bg.jpg')">
            <!--begin::Title-->
                ...
                <div class="d-flex flex-column px-9">
                    ...
                    <div class="text-center px-4">
                        <img class="mw-100 mh-200px" alt="image"
                             src="/assets_demo46/media/illustrations/sketchy-1/1.png"/>
                    </div>
                    <!--end::Illustration-->
                </div>
                <!--end::Wrapper-->
...
<div class="app-navbar-item ms-1 ms-lg-3">
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px"
        ...
        <div class="row g-0">
            <!--begin:Item-->
            <div class="col-6">
                <a href="/metronic8/demo46/../demo46/apps/projects/budget.html"
            ...
            <!--begin:Item-->
            <div class="col-6">
                <a href="/metronic8/demo46/../demo46/apps/projects/settings.html"
            ...
            <!--begin:Item-->
            <div class="col-6">
                <a href="/metronic8/demo46/../demo46/apps/projects/list.html"
            ...
            <!--begin:Item-->
            <div class="col-6">
                <a href="/metronic8/demo46/../demo46/apps/projects/users.html"
