    ...
    <div class="me-0">
        ...
        <div
            ...
            @if(false)
                ...
                <div class="menu-item px-3">
                    <a href="{{action([\App\Http\Controllers\Backend\CondominoController::class,'create'],['condominioId'=>$record->id])}}"
                       class="menu-link px-3">Nuovo {{ucfirst(\App\Models\Condomino::NOME_SINGOLARE)}}</a>
                </div>
                <div class="menu-item px-3">
