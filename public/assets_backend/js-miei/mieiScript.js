        ...
        $.ajax(url,
            {
                ...
                success: function (resp) {
                    if (resp.success) {
                        if (typeof resp.redirect !== 'undefined') {
                            location.href = resp.redirect;
                        } else if (typeof resp.oggettoReload !== 'undefined' && typeof resp.html !== 'undefined') {
                        ...
                        } else if (typeof resp.oggettoReplace !== 'undefined' && typeof resp.html !== 'undefined') {
